...
public class AddTeacher implements ActionListener {
	...
	public AddTeacher() {
        ...
        id2 = new JLabel("New Teacher Details");
        ...
        c1.setBounds(390,350,200,40);
        id1.add(c1);

        id14=new JLabel("Department");
        id14.setBounds(620,350,150,40);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                ...
                String q = "insert into teacher values('"+roll_no+"','"+fname+"','"+lname+"','"+fa_name+"','"+dob+"','"+ph+"','"+eid+"','"+addr+"','"+bran+"','"+cour+"','"+mari+"','"+aadhar+"','"+pass+"')";
