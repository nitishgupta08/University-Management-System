...
public class StudentFrame extends JFrame implements ActionListener {
	StudentFrame(String st){
		super("Student Control Panel");
        
        setSize(852,480);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("ums/Images/sp2.jpg"));
        ...
        JMenuItem a2 = new JMenuItem("My Attendance");
        ...
        JMenuItem c1 = new JMenuItem("Result");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(msg.equals("My Attendance")){
        	String w = StudentLogin.t1.getText();
            new MyAttendance(w,"a").setVisible(true);
            setVisible(false);
        }
      
        else if(msg.equals("Result")) {
        	String w = StudentLogin.t1.getText();
            new MyResult(w,"a").setVisible(true);
            setVisible(false);
           
        }
        else if(msg.equals("Change Password")) {
        	new StudentPassword().f.setVisible(true);
        	setVisible(false);
        }
